goals = [
    {'name': "travel", 'ru_name': "Для путешествий", 'emoji': '⛱'},
    {"name": "study", 'ru_name': "Для учебы", 'emoji': '🏫'},
    {"name": "work", 'ru_name': "Для работы", 'emoji': '🏢'},
    {"name": "relocate", 'ru_name': "Для переезда", 'emoji': '🚜'},
    {"name": "programming", 'ru_name': "Для программирования", 'emoji': '💻'}
]
